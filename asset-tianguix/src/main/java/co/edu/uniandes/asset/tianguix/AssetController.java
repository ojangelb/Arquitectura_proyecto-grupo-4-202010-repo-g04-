...
public class AssetController {
	...
	public @ResponseBody ResponseEntity<List<AssetDto>> searchAsset(@RequestParam String type,
			@RequestParam String currency, @RequestParam(required = false) Long currency_min,
		...
		return assetService.searchAssetByParams(type, currency, currency_min, currency_max, stock_ammount_min,
				stock_ammount_max);
	}
	...
	public @ResponseBody ResponseEntity<AssetSearchRsDto> searchAssetById(@PathVariable("id") String id) {
		
		return assetService.searchAssetById(id);
	}
